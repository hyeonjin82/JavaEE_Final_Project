    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${pages0}">Go Assingment3</a>
            </div>
      ...
      <div>
    	<h1> Welcome to update Provides Table </h1>	
    	<h4> Enter provides information here</h4>
		<form action="ManagerC" method="post">
		<input type="hidden" name="action" value="update"/>
		<input type="hidden" name="table" value="provide"/>
	    <div>
		<label>FoodService:</label>
		<input type="text" name="foodService"/>
		</div>
		<div>
		<label>Food:</label>
