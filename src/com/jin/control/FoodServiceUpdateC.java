...
/**
 * Servlet implementation class FoodServiceUpdateC
 */
@WebServlet("/FoodServiceUpdateC")
public class FoodServiceUpdateC extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FoodServiceUpdateC() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String url = "";
		if (ac.updateFoodService(foodService)) {
