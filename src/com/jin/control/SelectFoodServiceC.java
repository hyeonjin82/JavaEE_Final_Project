...
/**
 * Servlet implementation class SelectFoodServiceC
 */
@WebServlet("/SelectFoodServiceC")
public class SelectFoodServiceC extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectFoodServiceC() {
        super();
